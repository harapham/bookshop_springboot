...
//            	System.out.print(productDto.getImage());
//            	byte[] decodedString = Base64.getDecoder().decode(productDto.getImage().getBytes());
//                product.setImage(Base64.getEncoder().encodeToString(decodedString));
            }else{
	...
	public List<Product> getTop5Sale() {
		return productRepository.getTop5Sale();
	}
